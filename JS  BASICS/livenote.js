...
// reference - [] () {} - aisi koi bhi value jisko copy karne par real copy nahi hoti ,balki us mein value ka reference pass ho jata hai use hum reference value kaheta hai ,aur jiska copy karnepar real copy ho jaye vo value primitive value 
...
arr[0] // output = 1,...print the value at "0" index ||| current index of arr [0,1,2,3] ...
var arr = [1,2,3,4];
// arr.push(8); // "push" = add value in last of array ....
// console.log(arr);
// arr.pop(8); // "Pop" = remove last value in array ....
// console.log(arr);
// arr.unshift(8); // "unshift" = add value in start of array ....
// console.log(arr);
// arr.shift(8); // "shift" = remove value in start of array ....
arr.splice(2,1)
console.log(arr);
...
var ghadi = {
   ...
   type : "automatic",
   digital:false,
   kuchbolo:function(){} // ise hum "method" bolenge 
 }
